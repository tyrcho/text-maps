...
class DungeonGeneratorTest extends munit.FunSuite:
  ...
  test("room sizes are within valid bounds"):
    ...
    source match
      case DungeonMapSource.Manual(rooms, _, _) =>
        rooms.foreach { r =>
